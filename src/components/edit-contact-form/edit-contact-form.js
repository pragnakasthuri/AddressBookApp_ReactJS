...
const EditContactForm = (props) => {
    ...
    const [formValue, setForm] = useState(props.location.state.contact);
            ...
            <form action="#" className="form" onSubmit={save}>
                ...
                <div className="form-constrains">
                    <div className="row-content">
                        ...
                        <br/>
                        <input type="text" className="input" id="fullName" pattern='^[A-Z]{1}[a-z]{2,}$' onChange={changeValue} value={formValue.fullName} name="fullName" placeholder="Your name.." autoComplete="off" required />
                        <span>Name is invalid</span>
                    </div>
                    <div className="row-content">
                        <label htmlFor="phoneNumber" className="label text">Phone Number</label>
                        <br/>
                        <input type="tel" className="input" id="phone" pattern='^[0-9]{10}$' onChange={changeValue} value={formValue.phone} name="phone" placeholder="Your phone number.."
                    ...
                    <div className="row-content">
                        ...
                        <br/>
                        <textarea name="address" id="address" pattern='^[A-Z]{1}[a-z]{2,}$' placeholder="Your address" value={formValue.address} onChange={changeValue} autoComplete="off" required></textarea>
                    ...
                    <div className="row-content">
                        <div className="column-constrains">
                            <div className="column-content">
                                ...
                                { 
                                    cities.map(city => {
                                        return (<option value={city} selected={formValue.city === city}>{city}</option>);
                                    })
                                }
                                </select>
                            </div>
                            ...
                            <div className="column-content">
                                ...
                                { 
                                    states.map(state => {
                                        return (<option value={state} selected={formValue.state === state}>{state}</option>);
                                    })
                                }
                                </select>
                            </div>
                            ...
                            <div className="column-content">
                                ...
                                <br/>
                                <input type="text" className="input zipcode" id="zip" pattern='^[0-9]{6}$' value={formValue.zip} onChange={changeValue} name="zip" autoComplete="off" placeholder="Your zipcode.." required />
                                <span>Zip is invalid</span>
                            </div>
                        </div>
                    </div>
                    <div className="buttons-contact">
                        <button type="submit" className="button button-submit" id="submitButton">Update</button>
